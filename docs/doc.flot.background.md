* <strong>background</strong>: <strong>Plugin to fraw background and/or overlay</strong>.<br>Background is drawn on an additional canvas context. Critical point is the use of zIndex, since some plugins change zIndex to negativ values.<br>See option zIndex how to handle this.
